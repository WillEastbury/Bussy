...
void fetchRelayStatus() {
  ...
  if (httpResponseCode == 200) 
  {
    ...
    String place = hostshort + " Tappy status:";
    ...
    display.print("Cold Tap: "); display.println(cold); //display.print(colds);
    display.print("Hot Tap: "); display.println(hot); //display.print(hots);
